...
export class User {
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                                ...
                                <tr>
                                  <td align="left">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td> <a href=${`${process.env.API_URL}/verify-email?token=${token}`} target="_blank">Validar Email</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                            ...
                            <p>Este email serve apenas para você confirmar que o email que deseja cadastrar em nosso website é valido.</p>
                            <p>Faça um bom uso do nosso website.</p>
                          </td>
                        </tr>
                      </table>
                    </td>
  ...
  async sendEmailToForgotPassword() {
    const auth = new Auth();
                    ...
                    <td class="wrapper">
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            <p>Olá</p>
                            <p>Não tem problema esquecer a senha, clica no botao abaixo para redefinir sua senha</p>
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                              <tbody>
                                <tr>
                                  <td align="left">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td> <a href=${`${process.env.API_URL}/forgot-password?token=${token}`} target="_blank">Redefinir senha</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                            ...
                            <p>Este email serve apenas para você redefinir sua senha</p>
                            <p>Faça um bom uso do nosso website.</p>
                          </td>
                        </tr>
                      </table>
